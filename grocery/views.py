...
def view_cart(request):
    ...
    for item in cart:
        product_name = item.product.category
        # print(product_name)
    total=0
    num1=0
    ...
    print(product_name)
    recommended_products = recommend_products_by_label(product_name, num_recommendations=5)
    print(recommended_products)
    d = {'profile':profile,'cart':cart,'total':total,'num1':num1,'book':book_id,'message':message1,"recommendations":recommended_products}
